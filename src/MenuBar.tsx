...
function MenuBar() {
    ...
    return <div className='sm:flex '>
        <div className="text-slate-700 dark:text-slate-300 sm:flex-col sm:flex hidden justify-center items-center bg-neutral-100 dark:bg-slate-800 dark:shadow-sm sm:border-t-0 border-t-2">
            <Link to={"/"}>
